...
CREATE TABLE `id12846177_serprehn`.`Servicios_Publicados` (
  ...
  `Resumen_Descripcion` VARCHAR(45) NOT NULL,
  `Detalle_Descripcion` VARCHAR(100) NOT NULL,
  `Precio` FLOAT NOT NULL,
  `Moneda` VARCHAR(20) NOT NULL,
  `ID_Usuario_Publicador` INT NOT NULL,
  PRIMARY KEY (`ID_Servicio`),
  CONSTRAINT `CHK_MONEDA` CHECK(`Moneda` IN('Lempira','Dolar','Euro')),
  INDEX `fk_Servicios_Publicados_Usuarios_Registrados_idx` (`ID_Usuario_Publicador` ASC),
  CONSTRAINT `fk_Servicios_Publicados_Usuarios_Registrados`
