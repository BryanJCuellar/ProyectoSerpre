...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
        ...
        <div class="site-mobile-menu-body">
            <ul>
                <li style="list-style:none !important;"><a href="perfilUsuario.php" class="font-16-weight nav-link enlace-cursor-color">[Mi Perfil]</a></li>
                ...
                <div class="col-12 col-md-12 main-menu">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu mr-auto d-none d-lg-block">
                            <li><a href="perfilUsuario.php" class="font-16-weight nav-link enlace-cursor-color">[Mi Perfil]</a></li>
        ...
        <div class="container-fluid background-container-menu">
            <div class="div-contenido-servicios">
                ...
                <!--TARJETAS DE INICIO-->
                <h4 class="color-w"> <a href="cursos.php" style="color:white">Cursos</a> </h4> 
                <div class="row">
                ...
                <hr class="background-color-w"><br><br>
                <h4 class="color-w"><a href="" style="color:white">Tutorias</a></h4>
                <div class="row">
                    <div class="col-sm">
                        <div class="card text-center border-0" style="width: 18rem;">
